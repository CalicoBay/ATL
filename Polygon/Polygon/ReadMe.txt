========================================================================
    ACTIVE TEMPLATE LIBRARY : Polygon Project Overview
========================================================================

AppWizard has created this Polygon project for you to use as the starting point for
...
Polygon.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Polygon.h)
        GUID definitions                                (Polygon_i.c)
        A type library                                  (Polygon.tlb)
        Marshaling code                                 (Polygon_p.c and dlldata.c)

Polygon.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Polygon.idl. It will be regenerated by MIDL during compilation.
...
Polygonps.vcxproj
	...
	dlldata.c, Polygon_i.c and Polygon_p.c which are required
	to build the proxy/stub DLL.

Polygonps.vcxproj.filters
